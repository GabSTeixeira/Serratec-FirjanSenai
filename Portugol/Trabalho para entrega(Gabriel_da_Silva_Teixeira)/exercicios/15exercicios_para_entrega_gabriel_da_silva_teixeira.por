			...
			se (opcao == 0) pare
		  	escolha (opcao) {
				...
				caso 5:
					...
					cadeia matrizQuadrado[20][20]

					escreva("escrito "+matrizQuadrado[20][20]+"\n\n")
				...
				caso 6:
					...
					cadeia matrizQuadroAberto[20][20]
					...
					para(inteiro i = 0; i < ladoDoQuadro_exe6; i++) {
						para (inteiro j = 0; j < ladoDoQuadro_exe6; j++){
							escreva(matrizQuadroAberto[i][j])
						}
						escreva("\n")	
					}
 ...
 * @POSICAO-CURSOR = 8750; 
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {matrizQuadrado, 253, 12, 14}-{matrizQuadroAberto, 294, 12, 18};
