programa
{
	...
	funcao gerarNovoOrcamento(){
		...
		senao calcularOrcamento(opcaoCorreta)
	}
 ...
 * 
 * @POSICAO-CURSOR = 2294; 
 * @DOBRAMENTO-CODIGO = [105, 159, 172, 235, 258, 271, 299, 334, 349, 354, 359, 365, 371, 382, 388, 395, 409, 422, 528, 555, 565, 571, 583];
 * @PONTOS-DE-PARADA = ;
 * @SIMBOLOS-INSPECIONADOS = {letraInicial, 490, 31, 12}-{letraFinal, 490, 50, 10}-{texto, 492, 9, 5};
