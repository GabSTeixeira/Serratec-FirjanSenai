programa
{
			...
			se (opcao != "") {
				escolha (txt.obter_caracter(opcao, 0)){
					...
					caso '2': 
							...
							imprimirOrcamento(metodoPagamento, falso)
	...
	funcao calcularOrcamento (inteiro metodoPagamento){
		...
		limpa()
		imprimirOrcamento (metodoPagamento, verdadeiro)
	...
	funcao imprimirOrcamento(inteiro metodoPagamento, logico calcular){
